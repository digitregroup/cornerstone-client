const CORNERSTONE_PATH = '/services/api/x/odata/api/views/';
...
module.exports = () => {
  return {
    ...
    CORNERSTONE_PATH                              : CORNERSTONE_PATH,
    CORNERSTONE_REPORTING_USER                    : 'vw_rpt_user',                                                    // Main view to getRestApi all user data
    CORNERSTONE_REPORTING_USER_BASE               : 'vw_rpt_user_base',                                               // Main view to user data
    CORNERSTONE_REPORTING_KEYCODE                 : 'vw_rpt_training_unit_key_code',                                  // Main view to getRestApi training unit key code data
    CORNERSTONE_REPORTING_TRAINING                : 'vw_rpt_training',                                                // Main view to get training data
    CORNERSTONE_REPORTING_TRANSCRIPT              : 'vw_rpt_transcript',                                              // Main view to get all user transcript related data
    CORNERSTONE_REPORTING_CUSTOM_FIELDS           : 'vw_rpt_custom_field_value_local',                                // Main view to get all user custom fields value
    CORNERSTONE_REPORTING_OU                      : 'vw_rpt_ou',                                                      // Reporting Organizational Unit (OU) data
    ...
    CORNERSTONE_SERVICE_CUSTOM_FIELDS_BY_USER     : '/services/api/x/users/v1/employees/{user_id}/customfields',      // Custom fields by user_id
    CORNERSTONE_SERVICE_GROUPS                    : '/services/api/x/users/v1/employees/groups',                      // employee groups
    CORNERSTONE_SERVICE_GROUPS_BY_USER            : '/services/api/x/users/v2/employees/{user_id}/groups',            // groups by user_id
    CORNERSTONE_SERVICE_EMPLOYMENT_STATUS         : '/services/api/x/users/v2/employees/{id}/employment-status',       // Employment Status GET/PUT also supports different identifier types
